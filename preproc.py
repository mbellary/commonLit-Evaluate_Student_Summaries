...
def main(dir_path, model_path):
	...
	print(start_msg)
	train_prompts_df = pl.read_csv(dir_path + "dataset/commonlit-evaluate-student-summaries/prompts_train.csv")
	train_summaries_df = pl.read_csv(dir_path + "dataset/commonlit-evaluate-student-summaries/summaries_train.csv")
